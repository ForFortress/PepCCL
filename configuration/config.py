...
def get_train_config():
    ...
    parse.add_argument('-num-layer', type=int, default=3, help='number of encoder blocks') # 2
    ...
    parse.add_argument('-epoch', type=int, default=180, help='number of iteration')
    ...
    parse.add_argument('-device', type=int, default=3, help='device id')
